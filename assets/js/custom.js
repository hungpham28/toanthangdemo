    ...
    var filterList = {
      init: function () {
        $('#portfoliolist').mixItUp({
          ...
          load: {
            filter: '.math, .physics, .chemistry, .literature, .english'  
          }     
        });    
      }
    };
...
$('#btn-more-coure').on('click',function(){
  $('.portfolio_item').css('display','inline-block')
